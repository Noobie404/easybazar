...
@endpush
@section('product-pending','active')
                                        ...
                                        @foreach($rows as $row)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <img src="{{asset($row->PRIMARY_IMG_RELATIVE_PATH)}}" class="img-fluid" style="height: 50px;">
                                                    @else
                                                    <img src="{{asset('app-assets/images/no_image.jpg')}}" class="img-fluid" style="height: 50px;">
                                                    @endif
                                                </td>
