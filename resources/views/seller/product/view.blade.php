                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="{{$variant_id == $row->PK_NO ? 'active_tr' : '' }}">
                                                            ...
                                                            <td class="pinfo" style="width: 20%">
                                                                ...
                                                                <div><strong>Postage for SM :</strong> <i>{{number_format($row->LOCAL_POSTAGE,2)}}</i></div>
                                                                <div><strong>Postage for SS :</strong><i>{{number_format($row->INTER_DISTRICT_POSTAGE,2)}}</i></div>
                                                            </td>
