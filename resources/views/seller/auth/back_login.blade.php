...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../../../app-assets/images/ico/Azura_logo_favicon.png">
                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                ...
                                <div class="card-title text-center">
                                    <div class="p-1"><img src="{{url('app-assets/images/logo/azuramart-512.png')}}" alt="branding logo" style="width: 120px;"></div>
                                </div>
                                @if ($errors->any())
