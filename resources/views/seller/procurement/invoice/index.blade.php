...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('seller.dashboard') }}">@lang('invoice.breadcrumb_title')</a></li>
                ...
                <div class="col-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-3">
                                    <a class="text-white btn btn-round btn-sm btn-primary" href="{{route('seller.invoice.new')}}"  title="Add new invoice"><i class="ft-plus text-white"></i> @lang('invoice.create_btn')</a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                {!! Form::open(['method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate' , 'id' => 'bill_gen_frm', 'route' => 'seller.mer_bill.create' ] ) !!}
...
<script>
    $(document).ready(function() {
        ...
        var table   = $('#process_data_table').DataTable({
            ...
            aaSorting: [],
            ajax: {
                url: get_url+'/seller/invoice/list',
                type: 'POST',
                data: function(d) {
                    d._token        = "{{ csrf_token() }}";
                }
