...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('seller.vendor') }}"> Vendor </a>
    </li>
...
@section('content')
    <div class="card card-success min-height">
        ...
        <div class="card-content collapse show">
            <div class="card-body">
                {!! Form::open([ 'route' => 'seller.vendor.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {!! $errors->has('phone') ? 'error' : '' !!}">
                                    ...
                                    <div class="controls">
                                        {!! Form::text('phone', null,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter phone number', 'tabindex' => $tab_index++ ]) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group {!! $errors->has('country') ? 'error' : '' !!}">
                                    ...
                                    <div class="controls">
                                        {!! Form::select('country', $country, null, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select country', 'data-validation-required-message' => 'This field is required','tabindex' => $tab_index++]) !!}
