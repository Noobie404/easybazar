...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('seller.dashboard') }}">@lang('invoice_details.breadcrumb_title')</a></li>
                ...
                <div class="card card-success">
                    <div class="card-header">
                        ...
                        @if(hasAccessAbility('edit_invoice', $roles))
                            <a class="text-white" href="{{ route('seller.invoice.edit',['id' => $invoice->PK_NO, 'invoice_for' => request()->get('invoice_for')]) }}">
