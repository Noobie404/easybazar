                            ...
                            <table class="table table-striped table-bordered table-sm alt-pagination" id="invoicetable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if (hasAccessAbility('view_warehouse_stock_view', $roles))
                                        <td>
                                            <a href="{{ route("seller.stock_price.view", [$item->PK_NO,'invoice_for='.request()->get('invoice_for')]) }}" class="btn btn-xs btn-success mb-05 mr-05" title="View Product"><i class="la la-eye"></i></a>
                                        </td>
                                        @endif
                                        @endif
                                    </tr>
