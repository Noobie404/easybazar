      ...
      <div class="col-md-12">
         <div class="card card-sm card-success" >
            <div class="card-content">
               <div class="card-body">
                  {!! Form::open([ 'route' => 'web.blog.article.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                  <div class="row">
                     <div class="col-md-12">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group {!! $errors->has('summary') ? 'error' : '' !!}">
                           <label>Summary</label>
                           <div class="controls">
                              {!! Form::textarea('summary', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter short description about the article', 'tabindex' => 3, 'rows' => 2 ]) !!}
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('category') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('category', $category, null, ['class'=>'form-control mb-1', 'id' => 'category', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Select category', 'tabindex' => 4]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('tags') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('tags', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Lifestyle,Home & Kitchen', 'tabindex' => 5]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('author') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('author', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'John Doe', 'tabindex' => 6]) !!}
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('is_feature') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('is_feature', ['1'=> 'YES','0'=> 'NO'], 1,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS FEATURE', 'tabindex' => 7]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('is_active', ['1'=> 'YES','0'=> 'NO'], 1,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS ACTIVE', 'tabindex' => 8]) !!}
                        ...
                        <div class="form-group {!! $errors->has('feature_image') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              <div class="fileupload @if(!empty($row->feature_image))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif " data-provides="fileupload" >
                                 ...
                                 <span class="img-note d-block"><i class="fa fa-bell" aria-hidden="true"></i>
                                    {{trans('form.image_size')}}  870 x 420 pixels</span>
