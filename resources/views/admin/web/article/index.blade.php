                  ...
                  <table class="table table-bordered">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td>{{$loop->index + 1}}</td>
                           <td>{{ $row->TITLE }}</td>
                           <td><img src="{{ asset($row->THUMBNAIL_IMAGE) }}" alt="" width="100px;" class="img-fluid"></td>
                           <td>

                              @if($row->IS_FEATURE==1) <span class="badge badge-success">Yes</span> @else <span class="badge badge-danger">No</span>@endif
                           </td>
                           <td>
