...
@section('page-name') Edit Article @endsection
@section('breadcrumb')
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('tags') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('tags', $row->TAGS, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Lifestyle,Home & Kitchen', 'tabindex' => 1]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('author') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('author', $row->AUTHOR_NAME, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'John Doe', 'tabindex' => 6]) !!}
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('is_feature') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('is_feature', ['1'=> 'YES','0'=> 'NO'], $row->IS_FEATURE,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 6]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('is_active', ['1'=> 'YES','0'=> 'NO'], $row->IS_ACTIVE,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 7]) !!}
