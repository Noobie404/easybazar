                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('is_active', ['1'=> 'YES','0'=> 'NO'], $row->IS_ACTIVE,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 9]) !!}
                     ...
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('section') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('section', ['1'=> 'Pages','2'=> 'Customer Services','3'=>'Footer Top'], $row->SECTION,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 9]) !!}
                     ...
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('icon') ? 'error' : '' !!}">
                           <label>Icon</label>
                           <div class="controls">
                              {!! Form::text('icon', $row->ICON, [ 'class' => 'form-control mb-1','placeholder' => 'Enter ICON', 'tabindex' => 2]) !!}
                     ...
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('for_app') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::checkbox('for_app', 1, $row->FOR_APP,['tabindex' => 8,'id'=>'for_app']) !!}
