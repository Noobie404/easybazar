      ...
      <div class="col-md-12">
         <div class="card card-sm card-success" >
            <div class="card-content">
               <div class="card-body">
                  {!! Form::open([ 'route' => 'web.page.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('title') ? 'error' : '' !!}">
                           <label>Title<span class="text-danger">*</span></label>
                           <div class="controls">
                              {!! Form::text('title', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Title', 'tabindex' => 1]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('subtitle') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('subtitle', null, [ 'class' => 'form-control mb-1','placeholder' => 'Enter Sub Title', 'tabindex' => 2]) !!}
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group {!! $errors->has('body') ? 'error' : '' !!}">
                           <label>Body</label>
                           <div class="controls">
                              {!! Form::textarea('body', null, [ 'class' => 'form-control mb-1 summernote', 'placeholder' => 'Enter short description about the article', 'tabindex' => 3, 'rows' => 3,'id' =>'text-editor' ]) !!}
                  ...
                  <div class="row">
                        ...
                        <div class="form-group {!! $errors->has('feature_image') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              <div class="fileupload @if(!empty($row->FEATURE_IMAGE))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif " data-provides="fileupload" >
                                 ...
                                 <br>
                                 <span class="MainToUpload edit-3-color" style="font-size: 12px; color: #bf4c4c;"><i class="fa fa-bell" aria-hidden="true"></i>
                                    {{trans('form.image_size')}}  870 x 420 pixes</span>
                        ...
                        <div class="form-group {!! $errors->has('banner_image') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              <div class="fileupload @if(!empty($row->BANNER))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif " data-provides="fileupload" >
                                 ...
                                 <span class="img-note d-block"><i class="la la-bell" aria-hidden="true"></i>
                                    {{trans('form.image_size')}}  1920 x 150 pixels</span>
                              </div>
                              {!! $errors->first('feature_image', '<label class="help-block text-danger">:message</label>') !!}
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::select('is_active', ['1'=> 'YES','0'=> 'NO'], 1,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS ACTIVE', 'tabindex' => 9]) !!}
                              {!! $errors->first('is_active', '<label class="help-block text-danger">:message</label>') !!}
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('section') ? 'error' : '' !!}">
                           <label>Web Section <span class="text-danger">*</span></label>
                           <div class="controls">
                              {!! Form::select('section', ['1'=> 'Pages','2'=> 'Customer Services','3'=>'Footer Top'], 1,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 9]) !!}
                              {!! $errors->first('section', '<label class="help-block text-danger">:message</label>') !!}
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('icon') ? 'error' : '' !!}">
                           <label>Icon</label>
                           <div class="controls">
                              {!! Form::text('icon', null, [ 'class' => 'form-control mb-1','placeholder' => 'Enter ICON', 'tabindex' => 2]) !!}
                     ...
                     <div class="col-md-4">
                        <div class="form-group {!! $errors->has('for_app') ? 'error' : '' !!}">
                           <label for="for_app">For App <span class="text-danger">*</span></label>
                           <div class="controls">
                              {!! Form::checkbox('for_app', 1, false,['tabindex' => 8,'id'=>'for_app']) !!}
                              {!! $errors->first('for_app', '<label class="help-block text-danger">:message</label>') !!}
                           </div>
                        </div>
                     </div>
