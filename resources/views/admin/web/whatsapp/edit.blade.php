            ...
            <div class="card card-sm card-success" >
                <div class="card-content">
                    <div class="card-body">
                                ...
                                {!! Form::open([ 'route' => ['web.home.whatsapp.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                            <label>Name </label>
                                            <div class="controls">
                                                {!! Form::text('name', $row->NAME, [ 'class' => 'form-control mb-1','placeholder' => 'Enter name', 'tabindex' => 1]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('phone') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('phone', $row->PHONE_NUMBER, [ 'class' => 'form-control mb-1','placeholder' => 'Enter whatsApp number', 'tabindex' => 2]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('default-msg') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('default_msg', $row->DEFAULT_MSG, [ 'class' => 'form-control mb-1','placeholder' => 'Enter default message', 'tabindex' => 2]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('designation') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('designation', $row->DESIGNATION, [ 'class' => 'form-control','placeholder' => 'Enter designation', 'tabindex' => 2]) !!}
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::select('is_active', ['1'=> 'YES','0'=> 'NO'], $row->IS_ACTIVE ?? NULL,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS ACTIVE', 'tabindex' => 6]) !!}
