...
@section('title') Custom link highlighter @endsection
@section('page-name') Create Custom link highlighter @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Custom link highlighter</a></li>
    <li class="breadcrumb-item active">Create Custom link highlighter</li>
@endsection
@push('custom_css')
        ...
        <div class="col-md-12">
            <div class="card card-sm card-success" >
                <div class="card-content">
                    <div class="card-body">
                                {!! Form::open([ 'route' => 'web.home.custom_link.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                                @csrf
                                {!! Form::hidden('title_id', 0, ['id' => 'title_id']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('title') ? 'error' : '' !!}">
                                            <label>Select source <span class="text-danger">*</span></label>
                                            <div class="controls">
                                                {!! Form::select('source', array('Category','Brand','Custom'),0, [ 'class' => 'form-control mb-1','id' => 'source','data-validation-required-message' => 'This field is required', 'tabindex' => 1]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('title') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls" id="scrollable-dropdown-menu">
                                                {!! Form::search('title', null, [ 'class' => 'form-control search-input mb-1','placeholder' => 'Enter title (30 letters)','data-validation-required-message' => 'This field is required', 'tabindex' => 2]) !!}
                                                {!! $errors->first('title', '<label class="help-block text-danger">:message</label>') !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('url_link') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::url('url_link', null, [ 'class' => 'form-control mb-1','placeholder' => 'Enter link', 'tabindex' => 3]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('validity_from') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('validity_from', null, [ 'class' => 'form-control mb-1 pickadate', 'placeholder' => 'Enter date', 'data-validation-required-message' => 'This field is required', 'tabindex' => 4 ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('validity_to') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('validity_to', null,  [ 'class' => 'form-control mb-1 pickadate', 'placeholder' => 'Enter date', 'data-validation-required-message' => 'This field is required', 'tabindex' => 5 ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::select('is_active',['1'=> 'YES','0'=> 'NO'], 1,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Select', 'tabindex' => 6]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {!! $errors->has('banner') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                ...
                                                {!! Form::file('banner', Null,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Banner', 'tabindex' => 7]) !!}
                                                </label>
