...
@section('title')Purchase Payments @endsection
@section('page-name')Purchase Payments @endsection
@section('breadcrumb')
                        ...
                        <div class="card-header">
                            <div class="form-group">
                                <div class="btn-group">
                                    ...
                                    @if(hasAccessAbility('new_payment_purchase', $roles))
                                    <a href="{{ route('payments.purchase.create') }}" class="btn btn-primary"> Add New <i class="fas fa-plus-circle d-none d-sm-inline-block"></i></a>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered alt-pagination table-sm" id="indextable">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">$31377.50</td>
                                                    <td >Dutch Bangla Bank[DBBL-0003]</td>
                                                    <td class="text-center">30th Apr, 2022</td>
                                                    <td class="text-center">Active</td>
                                                    <td>
                                                        <div class="btn-group"><a href="" class="btn btn-primary btn-sm has-tooltip" ><i class="fas fa-eye"></i></a> <a href="" class="btn btn-info btn-sm has-tooltip" ><i class="fas fa-edit"></i></a> </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
