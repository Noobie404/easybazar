...
{!! Form::open([ 'route' => [ 'admin.delivery_boy.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal','files' => true,'id'=>'deliveryBoyUpdate','novalidate']) !!}
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                ...
                <div class="controls">
                        {!! Form::text('name', $row->NAME, [ 'class' => 'form-control','data-validation-required-message' => 'This field is required','maxlength' => "255", 'tabindex' =>$tabindex++ ,'id' => 'name']) !!}
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('email') ? 'error' : '' !!}">
                ...
                <div class="controls">
                        {!! Form::email('email', $row->EMAIL, [ 'class' => 'form-control', 'data-validation-required-message' => 'This field is required','maxlength' => "255", 'tabindex' =>$tabindex++,'id' => 'email','required' ]) !!}
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('mobile_no') ? 'error' : '' !!}">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('mobile_no', $row->MOBILE_NO, [ 'class' => 'form-control','data-validation-required-message' => 'This field is required','maxlength' => "255", 'tabindex' =>$tabindex++,'id' => 'mobile_no','required' ]) !!}
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('sallery') ? 'error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::number('sallery', $row->MONTHLY_SALARY, [ 'class' => 'form-control','tabindex' =>$tabindex++,'id' => 'sallery']) !!}
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('per_delivery_comm') ? 'error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::number('per_delivery_comm', $row->PER_DELIVERY_COMM, [ 'class' => 'form-control','tabindex' =>$tabindex++,'id' => 'per_delivery_comm']) !!}
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('joining_date') ? 'error' : '' !!}">
                ...
                <div class="controls">
                    <input type="text" name="joining_date" class="form-control datepicker" tabindex="{{ $tabindex++ }}" id="joining_date" value="{{ $row->JOINING_DATE }}"/>
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::select('is_active', ['1'=> 'Yes','0'=> 'No'],$row->IS_ACTIVE,[ 'class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'tabindex' => $tabindex++ ]) !!}
        ...
        <div class="col-6">
            <div class="form-group {!! $errors->has('address') ? 'error' : '' !!}">
                ...
                <div class="controls">
                    {!! Form::textarea('address', $row->ADDRESS, [ 'class' => 'form-control', 'placeholder' => 'Enter name', 'data-validation-required-message' => 'This field is required','maxlength' => "255", 'tabindex' =>$tabindex++,'id' => 'address','required','rows'=>'3', 'cols'=>'50' ]) !!}
    ...
    <div class="col-md-12">
        ...
        <div class="controls">
            <div class="fileupload @if(!empty($row->PROFILE_PIC_URL))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif " data-provides="fileupload" >
                ...
                {{-- {!! Form::file('photo', Null,[ 'class' => 'form-control', 'data-validation-required-message' => 'This field is required','tabindex' => 11,'id'=>'photo']) !!} --}}
...
<script>
    $(function () {
        ...
        $("#deliveryBoyUpdate input,#deliveryBoyUpdate select,#deliveryBoyUpdate textarea").not("[type=submit]").jqBootstrapValidation();
        } );
</script>
