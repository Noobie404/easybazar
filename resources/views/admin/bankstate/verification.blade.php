                                                ...
                                                @if(isset($data['payments']) && count($data['payments']) )
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr class="cp_row c-p ">
                                                            ...
                                                            <td style="width: 120px;" class="cp_cust_name" >{{ $pay->CUSTOMER_NAME ?? $pay->RESHOP_NAME }}</td>
                                                            <td class="cp_paid_by">
                                                                @if($payment_note)
                                                                    {{ $payment_note }}
                                                                @endif
                                                            ...
                                                            <td  style="width: 80px;" class="text-right cp_pay_amount">
                                                                <span class="cp_amount" style="display:none;">{{ $pay->NAME }}</span>
                                                                {{ number_format($pay->NAME,2) }}
                                                            </td>
