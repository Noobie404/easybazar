                                    ...
                                    <div class="col-md-7">
                                       <div class="form-group {!! $errors->has('agent') ? 'error' : '' !!}">
                                            <div class="controls">
                                                ...
                                                {!! Form::select('agent', $agent, $booking->F_SHOP_NO ?? '', ['class'=>'form-control mb-1 select2', 'data-validation-required-message' => 'This field is required', 'id' => 'booking_under']) !!}
                                                {!! $errors->first('agent', '<label class="help-block text-danger">:message</label>') !!}
                                                @else
                                                {!! Form::select('agent', $agent, $booking->F_SHOP_NO ?? '', ['class'=>'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'id' => 'booking_under','style'=>'pointer-events:none']) !!}
                                                {!! $errors->first('agent', '<label class="help-block text-danger">:message</label>') !!}
                                                @endif
                                            </div>
                                        </div>
...
<script type="text/javascript" src="{{ asset('assets/pages/country.js?v-1.03')}}"></script>
<script type="text/javascript" src="{{ asset('assets/pages/cus_pro_search.js?v-1.57')}}"></script>
<script type="text/javascript" src="{{ asset('assets/pages/book_order.js?v-1.67')}}"></script>
