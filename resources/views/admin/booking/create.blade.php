                            ...
                            <div id="cus_no_section" class="col-md-2">
                                <div class="row">
                                    <div id="cus_add" class="col-md-3">
                                        <button type="button" style="min-width: 48px;" title="ADD CUSTOMER" class="btn btn-primary btn-sm search_mother_btn mt-2" id="cus_no_input" data-url={{ route('admin.customer.store.booking')}}>
...
<script type="text/javascript" src="{{ asset('assets/pages/country.js?v-1.06')}}"></script>
...
<script type="text/javascript" src="{{ asset('assets/js/common.js?v-1.06')}}"></script>
