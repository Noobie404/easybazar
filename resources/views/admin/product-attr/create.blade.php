...
@section('title') Product attribute | Create @endsection
@section('page-name') Create Product attribute @endsection
...
<div class="card card-success min-height">
    ...
    <div class="card-content collapse show">
        <div class="card-body">
            {!! Form::open([ 'route' => 'admin.product-attr.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                ...
                <div class="row">
                    <div class="col-md-4 offset-4">
                        <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::text('name', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter product attribute name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 2 ]) !!}
                    ...
                    <div class="col-md-4 offset-4">
                        <div class="form-group {!! $errors->has('title') ? 'error' : '' !!}">
                            <label>Title</label>
                            <div class="controls">
                                {!! Form::text('title', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter product attribute title', 'tabindex' => 3 ]) !!}
                    ...
                    <div class="col-md-4 offset-4">
                        <div class="form-group {!! $errors->has('type') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('type',$productAttrType ,null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 4 ]) !!}
                    ...
                    <div class="col-md-4 offset-4">
                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('is_active',array(1=>'Yes',0=>'No'), null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'tabindex' => 6 ]) !!}
