                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 pb-1">
                                        ...
                                        if ($string) {
                                            ...
                                            ?>
                                                <h5 style="color: #ED1C24"><b><a href="{{ asset($data['info']->MASTER_INVOICE_RELATIVE_PATH)}}" target="_blank" >{{ $data['info']->INVOICE_NO }}</a>
                                                 ({{ $data['total'] }}) <span style="color: #00A65A">{{ $available_qty }}
                                                @if (!isset($data['vat']) && $data['vat']->VAT_AMOUNT_PERCENT > 0)
                                                <?php
                                    ...
                                    <div class="col-md-4 pb-1">
                                        ...
                                        @endif --}}
                                        {{-- <h5><b>Regular Price:</b> {{  number_format($item->REGULAR_PRICE,2) }}</h5> --}}
                                        @endif
                                    </div>
