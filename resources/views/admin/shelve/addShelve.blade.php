                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('zone_barcode') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::text('zone_barcode', $data->ZONE_BARCODE ?? '',[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Zone Barcode', 'tabindex' => $tab_index++ ]) !!}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {!! $errors->has('warehouse') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::select('warehouse', $warehouse, $data->F_INV_WAREHOUSE_NO ?? 2, ['class'=>'form-control mb-1 select2', 'data-validation-required-message' => 'This field is required', 'id' => 'addressCombo', 'tabindex' => $tab_index++]) !!}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group {!! $errors->has('description') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::textarea('description', $data->DESCRIPTION ?? '', [ 'class' => 'form-control mb-1 summernote', 'placeholder' => 'Enter Description', 'tabindex' => $tab_index++, 'rows' => 3,'data-validation-required-message' => 'This field is required' ]) !!}
