                                    ...
                                    <div class="card-body bg-success">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                <h6 class="text-white">Customers / seller</h6>
                                                <h3 class="text-white">{{ $data['customer_count'] }} / {{ $data['seller_count']  }}</h3>
                                            </div>
                                            <div>
                            ...
                            <div class="pull-up">
                                <div class="card-content">
                                    <div class="card-body bg-success">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                <h6 class="text-white">Master / Variant</h6>
                                                <h3 class="text-white">{{ $data['product_master']  }} / {{ $data['product_variant']  }}</h3>
                                            </div>
                                            <div>
                                    ...
                                    <div class="card-body bg-blue-grey">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                ...
                                                <h5 class="text-white">{{ number_format($data['order_RM_value_today'],2) }} / {{ number_format($data['order_RM_value_7day'],2) }} / {{ number_format($data['order_RM_value_30day'],2) }} TK</h5>
                                    ...
                                    <div class="card-body bg-blue-grey">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                ...
                                                <h5 class="text-white">{{ number_format($data['order_dispatch_RM_value_today'],2) }} / {{number_format( $data['order_dispatch_RM_value_7day'],2) }} / {{ number_format($data['order_dispatch_RM_value_30day'],2) }} TK</h5>
                            ...
                            <div class="card-body bg-teal">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        ...
                                        <h5 class="text-white">{{ number_format($data['free_stock_purchase_price_rm'],2) }} TK (P)</h5>
                                        <h5 class="text-white">{{ number_format($data['free_stock_salses_price_rm'],2) }} TK (S)</h5>
                                    </div>
                                    <div>
                                        <i class="icon-basket-loaded font-large-2 float-right text-white"></i>
                                    </div>
                            ...
                            <div class="card-body bg-teal">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        ...
                                        <h5 class="text-white">{{ number_format($data['booked_not_dispatched_price_rm'],2) }} TK (Exisiting Order)</h5>
                                    </div>
                                    <div>
                                        <i class="icon-heart font-large-2 float-right text-white"></i>
                                    </div>
                            ...
                            <div class="card-body bg-teal" style="min-height: 118px;">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        ...
                                        <h3 class="text-white">{{ number_format($data['customer_free_credit'],2) }} TK</h3>
                                    </div>
                                    <div>
                                        <i class="icon-basket-loaded font-large-2 float-right text-white"></i>
                                    </div>
                            ...
                            <div class="card-body bg-teal" style="min-height: 118px;">
                                <div class="media d-flex">
                                    <div class="media-body text-left text-white">
                                        ...
                                        <h5 class="text-white">{{ number_format($data['cod_balance'],2) }} TK</h5>
                                    </div>
                                    <div>
                ...
                <div class="pull-up">
                    <div class="card-content">
                        <div class="card-body bg-cyan" style="min-height: 195px;">
                            ...
                            <hr>
                            @foreach ($data['top_seller'] as $item)
                            <div class="row">
                                <div class="col-3">
