...
@section('dashboard_seller','active')

@section('title_seller') Dashboard @endsection
                  ...
                  <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Welcome! Complete the to-do list to start your selling journey!</h4>
                            <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements text-success">
                                100% completed, keep up the good work!
                            </div>
                        </div>
                        <div class="card-content collapse show">
                            <div class="card-body pt-0">
                                <div class="row mb-1">
                                    <div class="col-3 col-md-3 col-sm-6 text-center mt-4">
                                        <h6>Seller Account</h6>
                                        <p class="danger">100%</p>
                                    </div>
                                    <div class="col-3 col-md-3 col-sm-6 text-center mt-4">
                        ...
                        <div class="card pull-up">
                            ...
                            <div class="card-content collapse show bg-hexagons">
                                <div class="card-body pt-0">
                                        ...
                                        <div class="media-list list-group">
                                            <a href="#" class="list-group-item media">
                                                <div class="media-left">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/icons/avatar-s-9.png') }}" alt="Generic placeholder image" width="48" height="48">
                                                </div>
                                    ...
                                    <div class="section">
                                        <div class="header mt-3">
                                            <h4 class="card-title">Notice Center </h4>
                                        </div>
                                        <div class="list-group">
                                            <a href="#" class="list-group-item text-dark"><h5>Dapibus ac facilisis in</h5></a>
                                            <a href="#" class="list-group-item text-dark"><h5>Dapibus ac facilisis in</h5></a>
                                            <a href="#" class="list-group-item text-dark"><h5>Dapibus ac facilisis in</h5></a>
                                            <a href="#" class="list-group-item text-dark"><h5>Dapibus ac facilisis in</h5></a>
                                            <a href="#" class="list-group-item text-dark"><h5>Dapibus ac facilisis in</h5></a>
                                        ...
                                        <a href="#" class="mt-2 text-center d-block">Show more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-4.png') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-5.png') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-6.png') }}" alt="Avatar">
                                                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-7.png') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-8.png') }}" alt="Avatar">
                                                </li>
                                                <li class="avatar avatar-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-1.png') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-2.png') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-3.png') }}" alt="Avatar">
                                                </li>
                                                <li class="avatar avatar-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-11.png') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle" src="{{ asset('assets/images/portrait/small/avatar-s-12.png') }}" alt="Avatar">
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
                            ...
                            <table id="recent-orders" class="table table-hover table-xl mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <span class="avatar avatar-xs">
                                                <img class="box-shadow-2" src="{{ asset('assets/images/portrait/small/avatar-s-4.png') }}" alt="avatar">
                                            </span>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('assets/images/portfolio/portfolio-1.jpg') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('assets/images/portfolio/portfolio-2.jpg') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('assets/images/portfolio/portfolio-4.jpg') }}" alt="Avatar">
                                                </li>
                                                <li class="avatar avatar-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <span class="avatar avatar-xs">
                                                <img class="box-shadow-2" src="{{ asset('assets/images/portrait/small/avatar-s-5.png') }}" alt="avatar">
                                            </span>
                                            <span>Doris R.</span>
                                        </td>
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('assets/images/portfolio/portfolio-5.jpg') }}" alt="Avatar">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('assets/images/portfolio/portfolio-6.jpg') }}" alt="Avatar">
                                                </li>
                                                <li class="avatar avatar-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <span class="avatar avatar-xs">
                                                <img class="box-shadow-2" src="{{ asset('assets/images/portrait/small/avatar-s-6.png') }}" alt="avatar">
                                            </span>
                                            <span>Megan S.</span>
                                        </td>
                                        <td class="text-truncate p-1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <span class="avatar avatar-xs">
                                                <img class="box-shadow-2" src="{{ asset('assets/images/portrait/small/avatar-s-7.png') }}" alt="avatar">
                                            </span>
                                            <span>Andrew D.</span>
                                        </td>
                                        <td class="text-truncate p-1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <span class="avatar avatar-xs">
                                                <img class="box-shadow-2" src="{{ asset('assets/images/portrait/small/avatar-s-9.png') }}" alt="avatar">
                                            </span>
                                            <span>Walter R.</span>
                                        </td>
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('assets/images/portfolio/portfolio-3.jpg') }}" alt="Avatar">
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
