...
@section('title') @lang('user_group.list_page_title') @endsection
@section('page-name')@lang('user_group.list_page_sub_title') @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">@lang('user_group.breadcrumb_title')</a></li>
    <li class="breadcrumb-item active">@lang('user_group.breadcrumb_sub_title')</li>
@endsection
                                ...
                                <div class="table-responsive p-1">
                                    <table class="table table-striped table-bordered alt-pagination50" id="indextable">
                                        ...
                                        @foreach($rows as $row)
                                            <tr>
                                                <td>{{$loop->index + 1}}</td>
                                                <td>{{$row->GROUP_FOR == 0 ? 'Easybazar' : 'Branch'}}</td>
