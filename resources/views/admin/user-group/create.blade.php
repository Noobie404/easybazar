...
@section('title') @lang('user_group.new_page_title') @endsection
@section('page-name') @lang('user_group.new_page_sub_title') @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">@lang('user_group.breadcrumb_title')</a></li>
    <li class="breadcrumb-item"><a href="{{ route('admin.permission-group') }}">@lang('user_group.breadcrumb_sub_title')</a></li>
    <li class="breadcrumb-item active">@lang('user_group.breadcrumb_title_active_1')</li>
@endsection
