<div class="row">
    <div class="col-md-12 col-sm-12">
        <a href="{{ route('admin.customer.refund') }}" class="btn btn-md btn-warning c-btn {{ request()->route()->getName() == 'admin.customer.refund' ? 'active' : ''}} " style="min-width:90px;">Customer list </a>
