                ...
                <div class="modal-body">
                   ...
                   <br>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            {!! Form::number('refund_amount', 0,[ 'class' => 'form-control mb-1 number-only max_val_check', 'placeholder' => 'Refund amount (TK)', 'tabindex' => 1 ,'data-min' => 1, 'data-max' => 0, 'id' => 'refund_amount', 'required', 'step' => '0.01']) !!}
                        </div>
                    </div>
                     <div class="form-group">
                        <label>Note </label>
