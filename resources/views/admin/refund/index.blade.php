                    ...
                    <table class="table p84" style="width: 80%; margin: 0 auto;">
                        <tbody><tr class="bg-yellow">
                         ...
                         <tr class="bg-gray">
                            ...
                            <td>(TK) <strong id="c_balance">0</strong></td>
                        </tr>
                    </tbody></table>
                   <br>
                   <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            {!! Form::number('refund_amount',null,[ 'class' => 'form-control mb-1 number-only max_val_check', 'placeholder' => 'Refund amount (TK)', 'tabindex' => 5 ,'data-min' => 1, 'data-max' => 0, 'id' => 'refund_amount', 'required', 'step' => '0.01', 'autocomplete' => 'off']) !!}
                        </div>
                    </div>
