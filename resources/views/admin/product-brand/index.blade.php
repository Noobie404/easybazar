        ...
        <div class="card card-sm card-success">
          ...
          <div class="card-content  collapse show">
            <div class="card-body card-dashboard text-center">
                <div class="card-header" style="mb-4">
                <div class="row">
                    <div class="col-12">
                        <form class="form-inline" action="{{ route('product.brand.list') }}" method="get">
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Brand name" name="brand" value="{{ request()->get('brand') ?? '' }}">
                            </div>
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Model name" name="model" value="{{ request()->get('model') ?? '' }}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Color name" name="color" value="{{ request()->get('color') ?? '' }}">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Size name" name="size" value="{{ request()->get('size') ?? '' }}">
                            </div>

                            <button type="submit" class="btn btn-primary">Search</button>
                            <a href="{{ route('product.brand.list') }}" class="btn btn-info">Reset</a>
                          </form>
                    </div>
                </div>
                </div>
...
<script type="text/javascript" src="{{ asset('assets/pages/brand.js?v=1.29')}}"></script>
@endpush('custom_js')
