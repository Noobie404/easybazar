...
@section('page-name') @lang('invoice.list_page_sub_title') {{ request()->get('invoice_for') == 'merchant' ? 'for '.$merchant->NAME : '' }}@endsection
...
<div class="card card-success min-height">
    <div class="card-header">
        <h4 class="card-title" id="basic-layout-colored-form-control"><i class="ft-plus text-primary"></i> Edit Invoice</h4>
        @if($errors->any())
    ...
    <div class="card-content collapse show">
        <div class="card-body">
            ...
            <input type="hidden" name="invoice_for" value="{{ request()->get('invoice_for') == 'merchant' ? 'merchant' : 'azuramart' }}">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('store_no') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('store_no', $stores, $invoice->F_SHOP_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'store_no', 'onchange' => "getPurchaser(this)"  ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('vendor') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                  <select class="form-control mb-1" required data-validation-required-message="This field is required" tabindex="{{ $tab_index++ }}" id="vendor_id" name="vendor">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('invoice_no') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::text('invoice_no', $invoice->INVOICE_NO,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Please scan or enter', 'tabindex' => $tab_index++,'required' ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('invoice_date') ? 'error' : '' !!}">
                            ...
                            <div class="input-group">
                                ...
                                <input type='text' class="form-control pickadate" placeholder="Invoice Date" value="{{date('d-m-Y', strtotime($invoice->INVOICE_DATE))}}" name="invoice_date" required tabindex="{{ $tab_index++ }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('payment_source') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('payment_source', $accSource, $invoice->F_PAYMENT_SOURCE_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'acc_source','required', 'data-url' => URL::to('bank_acc') ]) !!}
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('acc_bank') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('acc_bank', $bankAcc, $invoice->F_PAYMENT_ACC_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select','required', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'bank_acc']) !!}
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('payment_methods') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('payment_methods', $paymentMethod, $invoice->F_PAYMENT_METHOD_NO, [ 'class' => 'form-control mb-1 select2', 'required','placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'payment_method']) !!}
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('store_no') ? 'error' : '' !!}">
                            <label>Payment Method<span class="text-danger">*</span></label>
                            <div class="controls">
                                {!! Form::select('store_no', $stores, $invoice->F_STORE_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select','required', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'store_no']) !!}
                                {!! $errors->first('store_no', '<label class="help-block text-danger">:message</label>') !!}
                            </div>
                        </div>
                    </div> --}}
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('discount_percentage') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::number('discount_percentage', $invoice->DISCOUNT_PERCENTAGE,[ 'class' => 'form-control mb-1', 'placeholder' => 'Enter primary discount percentage', 'tabindex' =>$tab_index++, 'step' => '0.01','min' => 0, 'data-validation-number-message' => 'Please enter max 2 decimal point']) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('discount_percentage') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::number('discount_percentage2', $invoice->DISCOUNT2_PERCENTAGE, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter secondary discount percentage', 'tabindex' =>$tab_index++, 'step' => '0.01','min' => 0, 'data-validation-number-message' => 'Please enter max 2 decimal point']) !!}
                                {!! $errors->first('discount_percentage', '<label class="help-block text-danger">:message</label>') !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('invoice_exact_value') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::text('invoice_exact_value', $invoice->INVOICE_EXACT_VALUE, [ 'class' => 'form-control', 'placeholder' => 'Enter invoice exact value','required', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('exact_vat') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::number('exact_vat', $invoice->INVOICE_EXACT_VAT, [ 'class' => 'form-control mb-1 ', 'placeholder' => 'Enter exact vat amount', 'tabindex' => $tab_index++, 'id' => 'exact_vat', 'step' => '0.01' ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('postage') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::number('postage', $invoice->INVOICE_EXACT_POSTAGE, [ 'class' => 'form-control mb-1 ', 'placeholder' => 'Enter local postage', 'tabindex' => $tab_index++, 'id' => 'postage', 'step' => '0.01' ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('purchaser') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('purchaser', $user, $invoice->F_PURCHASER_USER_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select purchaser','required', 'data-validation-required-message' => 'This field is required', 'tabindex' => $tab_index++]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('currency') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                <select class="form-control mb-1 select2" data-validation-required-message="This field is required" tabindex="{{ $tab_index++ }}" required name="currency" id="purchase_currency">
                                    <option value="">Select currency</option>
                                    @if($currency)
                                    @foreach($currency as $key => $val)
                                    <option value="{{$val->PK_NO}}" data-rate="{{$val->EXCHANGE_RATE_GB}}" data-code="{{$val->CODE}}" {{ $invoice->F_SS_CURRENCY_NO == $val->PK_NO ? 'selected=true' : '' }}>{{$val->NAME}}</option>
                                    @endforeach
                                    @endif
                                </select>
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('has_loyality') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('has_loyality', ['1' => 'Yes', '0' => 'No'], $invoice->HAS_LOYALTY, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select','required', 'data-validation-required-message' => 'This field is required', 'tabindex' => $tab_index++, 'id' => 'has_loyality']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {!! $errors->has('description') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::textarea('description', $invoice->DESCRIPTION, [ 'class' => 'form-control mb-1 summernote', 'placeholder' => 'Enter short notes or parent invoice reference', 'tabindex' => $tab_index++, 'rows' => 3 ]) !!}
                                        ...
                                        <table class="table table-striped table-bordered table-sm" id="indextable" style="font-size: 13px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th title="Product variant name">Item Name</th>
                                                    <th title="Product variant barcode" >Bar Code</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('admin.invoice-details.delete', ['id' => $row->PK_NO,'invoice_for' => request()->get('invoice_for') ]) }}" onclick="return confirm('Are You Sure?')" title="INVOICE DELETE"  class="btn btn-xs btn-danger mr-05"><i class="la la-trash"></i></a>
                                                    </td>
                                                    @endif
                                                    @endif
                                                </tr>
                ...
                <hr>
                 <p style="margin-left: 15px;">Images</p>
                    <div class="row">
                        ...
                        @if($photo->FILE_EXT == 'pdf')
                        <div style="padding: 10px; border: 1px solid #ccc;">
                            <a href="{{asset($photo->RELATIVE_PATH)}}" class="link" target="_blank">Click for show pdf</a>
            ...
            <div class="form-actions mt-10 text-center">
                <a href="{{ route('admin.invoice')}}?invoice_for={{ request()->get('invoice_for') }}" class="btn btn-warning mr-1" title="Cancel" ><i class="ft-x"></i> Cancel </a>
...
<script>
   ...
   $(document).on('click','.photo-delete', function(e){
    ...
    var invoice_for = "{{ request()->get('invoice_for') ?? 'azuramart' }}";
    if ('' != id) {
        var pageurl = `{{ URL::to('imvoice_img_delete')}}/`+id+'/'+invoice_for;
        $.ajax({
            type:'get',
            url:pageurl,
            async :true,
...
$(document).ready(function () {
    ...
    // var INV_STOCK_RECORD_GENERATED = `{{ $invoice->INV_STOCK_RECORD_GENERATED }}`;
    // if(INV_STOCK_RECORD_GENERATED == 1){
        // $("input[type=number]").css("pointer-events", 'none');
    ...
    function getPurchaser(item){
        var id = item.value;
        var pageurl = get_url+'/invoice/getpurchaser/'+id;
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.response == true){
                    $('#purchaser_id').html(data.html);
                    $('#vendor_id').html(data.html2);
                } else {
                    $('#purchaser_id').html("<option value=''>data not found</option>");
                    $('#vendor_id').html("<option value=''>data not found</option>");
                }
            },
            complete: function (data) {
                $("body").css("cursor", "default");
