...
@section('page-name') Invoice | New @endsection
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('store_no') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('store_no', $stores, $branch_id, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'store_no', 'onchange' => "getPurchaser(this)"  ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('vendor') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                <select class="form-control mb-1 select2"  data-validation-required-message="This field is required" tabindex="{{ $tab_index++ }}" id="vendor_id" name="vendor">
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('payment_source') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('payment_source', $accSource, null, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required', 'tabindex' =>$tab_index++, 'id' => 'acc_source', 'data-url' => URL::to('bank_acc') ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {!! $errors->has('purchaser') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('purchaser', $user, null, ['id' => 'purchaser_id', 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select purchaser', 'data-validation-required-message' => 'This field is required', 'tabindex' => $tab_index++]) !!}
                    ...
                    {{-- <div class="col-md-4">
                        <div class="form-group {!! $errors->has('gbp_to_mr') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::number('gbp_to_mr', $gbpToMrRate->EXCHANGE_RATE_GB, [ 'class' => 'form-control mb-1','data-validation-required-message' => 'This field is required', 'step' => '0.001', 'placeholder' => 'Please enter rate', 'tabindex' => $tab_index++, 'min' => 0, 'data-validation-number-message' => 'Please enter max 3 decimal point', 'readonly' => true]) !!}
                    ...
                    <div class="col-md-4 notForGBP">
                        <div class="form-group {!! $errors->has('gbp_to_ac') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::number('gbp_to_ac', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Please enter rate', 'tabindex' => $tab_index++, 'step' => '0.001', 'min' => 0, 'data-validation-number-message' => 'Please enter max 3 decimal point','id' => 'gbp_to_ac', 'readonly' => true ]) !!}
