                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group {!! $errors->has('branch_id') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::select('branch_id', $branch, $vendor->F_SHOP_NO, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Select branch', 'tabindex' => $tab_index++ ]) !!}
