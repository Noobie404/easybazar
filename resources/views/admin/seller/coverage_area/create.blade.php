...
@endpush('custom_css')
{!! Form::open([ 'route' => 'admin.seller_area.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true,'id'=>'areaForm' , 'novalidate']) !!}
{!! Form::hidden('id', $seller->PK_NO, ['id'=>'id']) !!}
<div class="row">
    <div class="col-md-6">
 ...
 <div class="row">
     ...
     <div class="col-md-12">
         ...
         <div class="controls">
            <select name="subarea[]" class="form-control select2" id="subarea" data-validation-required-message="This filed is required" tabindex="4"  multiple="multiple">
                @if(!empty($seller->area))
                @foreach ($seller->area as $item)
