                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <h3><span class="label1">Reseller : </span> <span class="label2">{{ $booking->RESHOP_NAME }}  (RES -{{ $booking->getReseller->RESELLER_NO ?? '' }} )</span></h3>
                                        @else
                                        <h3><span class="label1">Customer : </span> <span class="label2">{{ $booking->CUSTOMER_NAME }}  (CUST-{{ $booking->getCustomer->CUSTOMER_NO ?? '' }} )</span></h3>
                                        @endif
                                    </td>
                                    <td><h3><span class="label1">Entry By : </span>  <span class="label2">{{ $booking->createdBy->NAME }}</span> </h3></td>
                       ...
                       <div class="row">
                        ...
                        <div class="form-actions mt-10 text-center">
                            <a href="{{ route('admin.order.list')}}" class="btn btn-warning mr-1"><i class="ft-x"></i> @lang('order.order_frm_button_cancel_label')</a>
                                ...
                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#consignment" title="ADD NEW CONSIGNMENT NOTE"> <i class="la la-plus"></i>
                                    Add Consignment
                                  </button>
