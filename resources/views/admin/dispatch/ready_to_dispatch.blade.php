...
@section('ready_to_dispatch','active')
            ...
            <div class="bulk-update-form p-2">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! Form::select('booking_status',$booking_status,$booking_status[80],['id'=>'booking_status','class'=>'custom-select','placeholder'=>'Select Status','tabindex'=>$tab_index++,'data-validation-required-message' => 'This filed is required','required']) !!}
                        ...
                        <!-- <div class="form-group {!! $errors->has('booking_status') ? 'error' : '' !!}">
                            <div class="controls">
                                {!! Form::select('booking_status',$booking_status,$booking_status[80],['id'=>'booking_status','class'=>'form-control','placeholder'=>'Select Status','tabindex'=>$tab_index++,'data-validation-required-message' => 'This filed is required','required']) !!}
                            </div>
                        </div> -->
                    </div>
                    <!-- <div class="col-md-3">
                    <div class="form-group">
                        <div class="controls">
                            <button type="submit" class="text-white btn btn-round  btn-primary" title="Update">Update Status</button>
                        </div>
                    </div>
                    </div> -->
                </div>
