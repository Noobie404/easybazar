            ...
            <table class="table table-striped table-bordered table-sm">
                <tbody>
                    <tr>
                        ...
                        <td stye="width:33%">Account : {{ $data['data']->ex_account->BANK_ACC_NAME.' ('.$data['data']->ex_account->BANK_NAME.')' ?? '' }}</td>
                        <td stye="width:33%">Request At : {{ date('d-m-Y',strtotime($data['data']->SS_CREATED_ON)) ?? '' }}</td>
                    </tr>
                    <tr>

                        <td stye="width:33%">Account Head : {{ $data['data']->account_head->NARRATION ?? '' }}</td>
                        <td stye="width:33%">Action By : {{ $data['data']->approveBy->NAME ?? '' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td stye="width:33%">Request By : <span style="text-transform: uppercase">{{ $data['data']->entryBy->NAME ?? '' }}</span></td>
                    ...
                    <tr>
                        <td stye="width:33%">Cash Flow : {{ $data['data']->IS_IN == 0 ? 'CASH OUT' : 'CASH IN' }}</td>
                        <td stye="width:33%"></td>
