...
@section('title') Request Party Payment @endsection
@section('page-name')Request Party Payment @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Request Party Payment</li>
@endsection
...
<div class="card card-success min-height">
    ...
    <div class="card-content collapse show">
        <div class="card-body">
            {!! Form::open([ 'route' => 'admin.account_to_other.store', 'method' => 'post', 'class' => 'form-horizontal paymentEntryFrm prev_duplicat_frm', 'files'
            => true , 'novalidate']) !!}
            ...
            <div class="form-body">
                <div class="row">
                    <div class="offset-md-4 col-md-4">
                        <div class="form-group {!! $errors->has('is_cash_in') ? 'error' : '' !!}">
                            <label>Select Cash IN/OUT<span class="text-danger">*</span></label>
                            <div class="controls">
                                {!! Form::select('is_cash_in',  [1=>'CASH IN',0=>'CASH OUT'] ?? [], $data['edit_data']->IS_IN ?? null, [ 'class' => 'form-control mb-1 select2
                                ', 'placeholder' => 'Please Select Cash IN/OUT', 'data-validation-required-message' => 'This field is required',  'id' => 'is_cash_in' ]) !!}
                ...
                <div class="row">
                    <div class="offset-md-4 col-md-4">
                        <div class="form-group {!! $errors->has('payment_acc_no') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('payment_acc_no',  $data['payment_bank'] ?? [], $data['edit_data']->F_I_ACC_PAYMENT_BANK_ACC_NO ?? null, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required',  'id' => 'payment_acc_no' ,isset($data['edit_data']) ? 'disabled' : '']) !!}
                ...
                <div class="row">
                    <div class="offset-md-4 col-md-4">
                        <div class="form-group {!! $errors->has('payment_method') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('payment_method',  $data['party_payment_method'] ?? [], $data['edit_data']->F_ACC_PARTY_PAYMENT_METHOD_NO ?? null, [ 'class' => 'form-control mb-1 select2
                ...
                <div class="row">
                    <div class="offset-md-4 col-md-4">
                        <div class="form-group {!! $errors->has('payment_type') ? 'error' : '' !!}">
                            <label>Select Account Head<span class="text-danger">*</span></label>
                            <div class="controls">
                                {!! Form::select('payment_type',  $data['party_payment_type'] ?? [], $data['edit_data']->F_ACC_PAYMENT_ACC_HEAD_NO ?? null, [ 'class' => 'form-control mb-1 select2
                                ', 'placeholder' => 'Select Account Head', 'data-validation-required-message' => 'This field is required',  'id' => 'payment_type' ]) !!}
                    ...
                    <div class="col-md-1">
                        <button type="button" title="ADD NEW TYPE" class="btn btn-primary btn-sm mt-2" id="add_payment_type" data-toggle="modal" data-target="#AddPaymentType" data-url="#!">
                    ...
                    <div class="offset-md-4 col-md-4">
                        <div class="form-group {!! $errors->has('payment_amount') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                ...
                                'data-validation-required-message' => 'This field is required','placeholder' => 'amount(RM)','min' => 1, 'id' => 'payment_amount', 'step' => '0.01']) !!}
                    ...
                    <div class="offset-md-4 col-md-4">
                        <div class="form-group {!! $errors->has('payment_note') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                ...
                                'note',  'payment_note', 'id' => 'payment_note','rows' => 3]) !!}
                ...
                <div class="row">
                    <div class="offset-md-4 col-md-4">
                        <h5>Upload Photo<span class="required"></span></h5>
...
<script>
    ...
    $(document).on('change','#payment_acc_no',function(){
        get_balance($(this).val(),'from_ex');
    })
