            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('address_type') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            {!! Form::select('address_type', $shippment_address_type_arr, $row->ADDRESS_TYPE, ['class'=>'form-control mb-1', 'id' => 'address_type', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Select address type', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter your name', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('mobilenoadd') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter mobile no', 'tabindex' =>$tab_index++]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('address_1') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'Enter your address 1', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('address_2') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'Enter your address 2', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('ad_3') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'Enter your address 3', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('ad_4') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            => 'Enter your address 4', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('location') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'placeholder' => 'Enter your location', 'tabindex' => $tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('post_code') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'placeholder' => 'EX- 2350', 'tabindex' => $tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('attention') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'placeholder' => 'Attention', 'tabindex' => $tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('vat_eori_no') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'placeholder' => 'Enter vat no', 'tabindex' => $tab_index++, ]) !!}
