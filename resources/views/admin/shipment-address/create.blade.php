            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('address_type') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            {!! Form::select('address_type', $shippment_address_type_arr, null, ['class'=>'form-control mb-1', 'id' => 'address_type', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Select address type', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('address_1') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'Enter your address', 'tabindex' =>$tab_index++, ]) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group {!! $errors->has('city') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            ...
                            'Select city', 'tabindex' =>$tab_index++, ]) !!}
