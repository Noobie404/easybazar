...
@section('title') New Arival @endsection
@section('page-name') New Arival @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('shipping.breadcrumb_title')</a></li>
    <li class="breadcrumb-item active">New Arival </li>
@endsection
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="category_name">Generate New Arrival</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            {!! Form::open([ 'route' => 'admin.newarival.create', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" id="from_date" class="form-control pickadate" name="from_date" title="" value="" data-validation-required-message ="This field is required" tabindex="{{ $tabindex++ }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="max_variant">Max Product</label>
                                <div class="controls">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary btn-sm submit-btn" value="Generate" title="Update" tabindex="{{ $tabindex++ }}" >
                </div>
            {!! Form::close() !!}
        </div>
    </div>
