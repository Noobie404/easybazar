              ...
              <div class="card card-success">
                <div class="card-header">
                    ...
                    @if(hasAccessAbility('new_offer_type', $roles))
                        <a  href="{{ route('admin.offer_type.create') }}" class="btn btn-sm btn-primary "  title="Add new offer"> <i class="ft-plus text-white"></i> Add new offer type</a>
                    @endif
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.offer_type.edit', [$row->PK_NO]) }}" class="btn btn-xs btn-primary mr-1" title="EDIT"><i class="la la-edit"></i></a>
                                    @endif
                                </td>
                                @endforeach
                                @endif
