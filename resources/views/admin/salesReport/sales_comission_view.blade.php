            ...
            <div class="col-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h3>Sales Report of <span style="color: #FFA702">{{ $report['total_comission'][0]->SHOP_NAME ?? '' }}</span> for the month of <span style="color: #FFA702" id="current_date">{{ date('F Y', strtotime(Carbon::now())) }}</span></h3>
            ...
            $('#process_data_table_').DataTable({
                ...
                columns: [
                        ...
                        },
                        {
                            ...
                            order: 'b.CONFIRM_TIME',
                            searchable: false,
                            render: function(data, type, row) {
                                return '<style="display:inline-block;">Entry: '+moment(row.SS_CREATED_ON).format("MMM DD, YY")+'</style=><br><span style="display:inline-block;">Order: '+moment(row.CONFIRM_TIME).format("MMM DD, YY")+'</span>';
                            }
                        },
                        {
                            data: 'USERNAME',
                        ...
                        },
                        {
                            ...
                            reseller: 'b.RESHOP_NAME',
                            searchable: false,
                            render: function(data, type, row) {
                                return row.RESHOP_NAME ?? row.CUSTOMER_NAME;
                            }
                        },
                        {
                            data: 'PK_NO',
