...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Edit Seller User
    </li>
@endsection
@push('custom_css')
    ...
    <div class="col-md-12">
        ...
        <div class="card card-success min-height">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    {!! Form::open([ 'route' => ['seller.seller-user.update', $user->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                    @csrf
                    <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    {!! Form::select('user_group', $userGroup, $user->F_GROUP_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Select Group name','required']) !!}
                                </div>
                    ...
                    <div class="form-actions text-center">
                        <a href="{{ route('seller.seller-user')}}" class="btn btn-warning mr-1" title="Cancel"><i class="ft-x"></i> Cancel</a>
