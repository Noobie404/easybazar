...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('seller.seller-user') }}"> Seller User </a>
    </li>
    <li class="breadcrumb-item active">Create Seller User
    </li>
@endsection
@push('custom_css')
...
@section('content')
        <div class="card card-success min-height">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    {!! Form::open([ 'route' => 'seller.seller-user.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                        @csrf
                        <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        {!! Form::select('user_group', $userGroup, null, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Select user group','data-validation-required-message' => 'This field is required','required']) !!}
                                    </div>
                        ...
                        <div class="form-actions mt-10 text-center">
                            <button type="button" class="btn btn-warning mr-1"><i class="ft-x"></i> <a style="color: #fff;" href="{{ route('seller.seller-user')}}" title="Cancel"> Cancel </a></button>
