...
@section('title') Create new offer group @endsection
@section('page-name') Create new offer group @endsection
        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-content collapse show">
                    <div class="card-body">
                        {!! Form::open([ 'route' => ['admin.offergroup.store'], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('name',null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter offer group name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('public_name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('public_name',null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter offer group public name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 2 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group {!! $errors->has('offers') ? 'error' : '' !!} mb-0">
                                                <div class="controls">
                                                    {!! Form::select('offers[]', $data['offers'] ?? array() , null, [ 'class' => 'form-control mb-1 js-select2','data-validation-required-message' => 'This field is required',  'tabindex' => 4, 'multiple' => true ]) !!}
