                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <td style="width: 10%" class="text-center img_td">
                                                    ...
                                                    @if(isset($product->allDefaultPhotos) && $product->allDefaultPhotos->count() > 0)
                                                ...
                                                <td class="pinfo" style="width: 20%">
                                                    ...
                                                    <div><strong>Category :</strong>
                                                        {{ getCategoryChain($product->PK_NO) }}
                                                        {{-- <i>{{ $product->category->PARENT_ID ?? '' }}</i>
                                                        >
                        ...
                        <div class="col-12">
                            <div class="card card-sm card-smart">
                                <div class="card-header">
                                    <h4 class="card-title"><span title="Product category name">{{ getCategoryChain($product->PK_NO) }}</span>&nbsp;:: Variants List
                                        @if($type == 'variant')
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <table class="table table-sm table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        @if(isset($product->allVariantsProduct) &&  $product->allVariantsProduct->count() > 0)
                                                        ...
                                                        <tr class="{{$variant_id == $row->PK_NO ? 'active_tr' : '' }}">
                                                            ...
                                                            <td class="pinfo" style="width: 20%">
                                                                ...
                                                                <div><strong>Price (Special) :</strong> <i>{{number_format($row->SPECIAL_PRICE,2)}}</i></div>
                                                                <div><strong>Price (Wholesale) :</strong> <i>{{number_format($row->WHOLSESALE_PRICE,2)}}</i></div>
                                                                <div><strong>Price (Ins) :</strong> <i>{{number_format($row->INSTALLMENT_PRICE,2)}}</i></div>
                                                            </td>

                                                            <td style="width: 35%">
                                                              <div>{!! $row->SHORT_NARRATION !!}</div>
                                                            </td>
                                                        </tr>
                                                        @endforeach()
                                                        @else
