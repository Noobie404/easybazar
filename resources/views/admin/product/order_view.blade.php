                                ...
                                <table class="table" id="order_view_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border-bottom: .1rem solid #ebebeb">
                                            ...
                                            <td>
                                                <span class="price">৳ {{ number_format($unit_price,2) }}</span>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                ৳ <span class="price"> {{ number_format($line_total,2) }}</span>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                ...
                                <table class="table table-responsive" id="order_view_table">
                                    ...
                                    <tbody>
                                        <tr style="border-bottom: .1rem solid #ebebeb">
                                            ...
                                            <td>
                                                <span class="price">৳ {{ number_format($unit_postage,2) }}</span>
                                            </td>
                                            <td class="account-order-table-item-qty">
                                                <p style="color:#212529">1</p>
                                            </td>
                                            <td class="text-right">
                                                ৳ <span class="price"> {{ number_format($unit_price+$unit_postage,2) }}</span>
