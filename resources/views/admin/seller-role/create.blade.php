...
@section('content')
    <div class="card card-success min-height">
        ...
        <div class="card-content collapse show">
            <div class="card-body">
                {!! Form::open([ 'route' => 'seller.role.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                @csrf
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="form-actions text-center">
                    <a href="{{ route('seller.role') }}" class="btn btn-warning mr-1" title="Cancel"> <i class="ft-x"></i> @lang('form.btn_cancle')</a>
