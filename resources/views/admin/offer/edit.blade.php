...
@section('title') Edit offer @endsection
@section('page-name') Edit offer @endsection
        ...
        <div class="col-md-10 offset-md-1">
            <div class="card card-success">
                <div class="card-content collapse show">
                    <div class="card-body">
                        {!! Form::open([ 'route' => ['admin.offer.update',$row->PK_NO ], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                                    ...
                                    <div class="form-group {!! $errors->has('offer_type') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            <select class="form-control mb-1" name="offer_type" id="offer_type" data-validation-required-message="This field is required" tabindex="1">
                                                ...
                                                data-zb2="{{ $type->ZB2 }}"
                                                data-zb3="{{ $type->ZB3 }}"
                                                {{ $row->F_BUNDLE_TYPE == $type->PK_NO ? 'selected' : '' }}
                                                > {{ $type->NAME }} </option>
                                                @endforeach
                                                @endif
                                            </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('banner_image') ? 'error' : '' !!}">
                                        <label>Banner Photo for Offer<span class="text-danger">*</span> 
                                        {{-- (2100X170) --}}
                                        </label>
                                        <div class="controls">
                                            {!! Form::file('banner_image', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter photo','data-validation-required-message' => 'This field is required','tabindex' => 2 ]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('name', $row->BUNDLE_NAME, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter offer name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 3 ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('public_name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('public_name', $row->BUNDLE_NAME_PUBLIC, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter offer name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 4 ]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-4 ">
                                    <div class="form-group {!! $errors->has('coupon_code') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('coupon_code', $row->COUPON_CODE, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter coupon code', 'tabindex' => 5 ]) !!}
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group {!! $errors->has('validity_from') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('validity_from', date('d-m-Y',strtotime($row->VALIDITY_FROM)), [ 'class' => 'form-control mb-1 pickadate', 'placeholder' => 'Enter date', 'data-validation-required-message' => 'This field is required', 'tabindex' => 6 ]) !!}
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group {!! $errors->has('validity_to') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('validity_to', date('d-m-Y',strtotime($row->VALIDITY_TO)),  [ 'class' => 'form-control mb-1 pickadate', 'placeholder' => 'Enter date', 'data-validation-required-message' => 'This field is required', 'tabindex' => 7 ]) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group {!! $errors->has('description') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::textarea('description', $row->DESCRIPTION, [ 'class' => 'form-control mb-1 ', 'placeholder' => 'Enter description', 'tabindex' => 7, 'rows' => 3 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group {!! $errors->has('lista') ? 'error' : '' !!} mb-0">
                                                <div class="controls">
                                                    {!! Form::select('lista', $data['list_a_combo'] ?? array() , $row->F_A_LIST_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Select A list','data-validation-required-message' => 'This field is required',  'tabindex' => 8 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('p_amount') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('p_amount', $row->P_AMOUNT, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter P amount','data-validation-required-message' => 'This field is required', 'tabindex' => 9 ]) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('p2_amount') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('p2_amount', $row->P2_AMOUNT, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter P2 amount','data-validation-required-message' => 'This field is required', 'tabindex' => 10 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('p_sm') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('p_sm', $row->P_SM, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter SM postage for A list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 11 ]) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('p_ss') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('p_ss', $row->P_SS, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter SS postage for A list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 12 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('p_air') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('p_air', $row->P_AIR, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter AIR cost for A list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 13 ]) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('p_sea') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('p_sea', $row->P_SEA, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter SEA cost for A list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 14 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('x1_qty') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('x1_qty', $row->X1_QTY, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter X1 quantity', 'data-validation-required-message' => 'This field is required', 'tabindex' => 15 ]) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('za1') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('za1', $row->ZA1, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter XA1 %', 'data-validation-required-message' => 'This field is required', 'tabindex' => 16 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('x2_qty') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('x2_qty', $row->X2_QTY, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter X2 quantity', 'data-validation-required-message' => 'This field is required', 'tabindex' => 17 ]) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('za2') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('za2', $row->ZA2, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter ZA2 %','data-validation-required-message' => 'This field is required',  'tabindex' => 18 ]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {!! $errors->has('za3') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    {!! Form::number('za3', $row->ZA3, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter ZA3 %', 'data-validation-required-message' => 'This field is required', 'tabindex' => 19 ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 ">
                                                <div class="form-group {!! $errors->has('listb') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::select('listb', $data['list_b_combo'] ?? array(), $row->F_B_LIST_NO, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Select B list', 'tabindex' => 20 ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('r_amount') ? 'error' : '' !!}">
                                                    <label class="text-normal">Option1 Price (P)<span class="text-danger">*</span></label>
                                                    <div class="controls">
                                                        {!! Form::number('r_amount', $row->R_AMOUNT, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter R amount', 'data-validation-required-message' => 'This field is required', 'tabindex' => 21 ]) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('r2_amount') ? 'error' : '' !!}">
                                                    <label class="text-normal">Option2 Price (P)<span class="text-danger">*</span></label>
                                                    <div class="controls">
                                                        {!! Form::number('r2_amount', $row->R2_AMOUNT, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter R2 amount', 'data-validation-required-message' => 'This field is required', 'tabindex' => 22 ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('y1_qty') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::number('y1_qty', $row->Y1_QTY, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter X1 quantity', 'data-validation-required-message' => 'This field is required', 'tabindex' => 23 ]) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('zb1') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::number('zb1', $row->ZB1, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter ZB1 %','data-validation-required-message' => 'This field is required',  'tabindex' => 24 ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('y2_qty') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::number('y2_qty', $row->Y2_QTY, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter Y2 quantity','data-validation-required-message' => 'This field is required',  'tabindex' => 25 ]) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('zb2') ? 'error' : '' !!}">
                                                    ...
                                                    <div class="controls">
                                                        {!! Form::number('zb2', $row->ZB2, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter ZB2 %','data-validation-required-message' => 'This field is required',  'tabindex' => 26 ]) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {!! $errors->has('zb3') ? 'error' : '' !!}">
                                                    <label class="text-normal">@lang('form.zb3%')<span class="text-danger">*</span></label>
                                                    <div class="controls">
                                                        {!! Form::number('zb3', $row->ZB3, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter ZB3 % quantity','data-validation-required-message' => 'This field is required','tabindex' => 27 ]) !!}
