                      ...
                      <table class="table table-striped table-bordered alt-pagination table-sm" id="indextable">
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $row->day_diff_with_current == 'No' ? 'text-danger' : '' }}">
                                ...
                                <td>
                                    @if($row->IMAGE)
                                    <a href="{{ asset($row->IMAGE) }}" target="_blank"><img src="{{ asset($row->IMAGE) }}"  width="50"/></a>
                                    @else
                                ...
                                <td>
                                    @if($row->BANNER_IMAGE)
                                        <a href="{{ asset($row->BANNER_IMAGE) }}" target="_blank"><img src="{{ asset($row->BANNER_IMAGE) }}"  width="70" height="40"/></a>
                                    @else
                                        <img src="{{ asset('/assets/images/offer-banner.jpg') }}"  width="70" height="30"/>
                                    @endif
                                </td>
                                ...
                                <td style="width: 110px;" class="text-center">Start: {{ date('d-m-Y', strtotime($row->VALIDITY_FROM)) }} <br> End: {{ date('d-m-Y', strtotime($row->VALIDITY_TO)) }} </td>
