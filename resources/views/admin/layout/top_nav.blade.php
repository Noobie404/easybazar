    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{url('clear')}}">
                  <span class="mr-1 user-name text-bold-700">Clear</span>
              </a>
        </li>
            ...
            <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700"> {{ Auth::user()->NAME }}</span><span class="avatar avatar-online"><img src="{{ asset(Auth::user()->PROFILE_PIC_URL) }}" alt="{{ Auth::user()->NAME }}"><i></i></span>
                </a>
