...
$city = $data['city'] ?? [];
?>
{!! Form::open([ 'route' => [ 'admin.address.area_update'], 'method' => 'post', 'class' => 'form-horizontal','id'=>'areaUpdateForm','novalidate']) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {!! $errors->has('region') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('region', $data['stateCombo'], $row->F_STATE_NO ?? null, [ 'class' => 'form-control', 'id'=>'region','data-validation-required-message' => 'This filed is required','tabindex'=>1,'required']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group {!! $errors->has('city') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('city', $city, $row->F_CITY_NO ?? null, [ 'class' => 'form-control', 'id'=>'city','data-validation-required-message' => 'This filed is required','tabindex'=>2,'required']) !!}
                            </div>
                        ...
                        <div class="form-group {!! $errors->has('area') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    {!! Form::text('area', $row->AREA_NAME, [ 'class' => 'form-control', 'placeholder' => 'Enter name', 'data-validation-required-message' => 'This field is required','maxlength' => "255", 'tabindex' =>3,'id' => 'cat_name','required' ]) !!}
    ...
    {!! Form::close() !!}
    <script>
        $(function () { $("#areaUpdateForm input,#areaUpdateForm select,#areaUpdateForm textarea").not("[type=submit]").jqBootstrapValidation(); } );
    </script>
