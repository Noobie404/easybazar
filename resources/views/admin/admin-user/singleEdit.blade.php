                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <div class="controls">
                                        {!! Form::text('first_name', $user->FIRST_NAME,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter name', 'tabindex' => 1 ]) !!}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Name</label>
                                <div class="controls">
                                    {!! Form::text('username', $user->NAME,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter name', 'tabindex' => 1 ]) !!}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <img align="middle" width="150" height="150"
                                         src="{{ asset($user->PROFILE_PIC_URL) }}" alt=" ">
