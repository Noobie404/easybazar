...
@section('title') Default Order @endsection
@section('page-name') Default Order @endsection
        ...
        <div class="card-body" style="padding: 15px 5px;">
            ...
            {{-- <div class="row">
                <div class="col-md-6 col-sm-6">
                    <a href="{{ route('admin.order_default.list') }}" class="btn btn-md btn-primary c-btn active" style="min-width:90px;">Dedault Order</a>
                    <a href="{{ route('admin.order_default_action.list') }}" class="btn btn-md btn-warning c-btn" style="min-width:90px;">Dedault Order Action</a>
                    <a href="javascript:void(0)" class="btn btn-md btn-info c-btn" style="min-width:90px;">Request For Cancellation</a>
                    <a href="javascript:void(0)" class="btn btn-md btn-danger c-btn" style="min-width:90px;">Cancelled Order</a>
                  </div>
            </div> --}}
            <hr>
            <div class="table-responsive p-1">
                <table class="table table-striped table-bordered table-sm" id="process_data_table">
                    ...
                    <tr>
                        ...
                        <th class=" text-center">Default At</th>
