                                                                                    ...
                                                                                    <table align="left" width="100%"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                @else
                                                                                                <img align="center" alt="easybazar" src="{{ $image_path }}/{{ 'assets/images/logo/easybazar-white.png' }}" width="248" style="max-width:112px;padding-bottom:0;display:inline!important;vertical-align:bottom;border:0;height:auto;outline:none;text-decoration:none">
                                                                                                @endif
                                                                                                </a>
                                                                                                </td>
                                                                                            </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top">
                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%;min-width:100%;border-collapse:collapse" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" style="padding-top:0;padding-right:30px;padding-bottom:30px;padding-left:30px;word-break:break-word;color:#5f7d95;font-family:Helvetica;font-size:16px;text-align:left">
                                                                                                <p style="font-size:26px;color:#374957;margin:0;font-weight:600;padding:0;font-family:Helvetica,Arial;line-height:150%;text-align:left">Order Return Notice!!!</p>
                                                                                                <p style="font-size:19px;color:#374957;margin-top:0;margin-bottom:20px;margin:10px 0;padding:0;font-family:Helvetica,Arial;line-height:150%;text-align:left">Dear, {{ $rows->DELIVERY_NAME }}</p>
                                                                                                <h4 style="color: #212121;font-size: 15px;">ORDER ID: <span style="color:#374957; font-weight: 100;">ORD-{{ $rows->BOOKING_NO }}</span></h4>
                                                                                                <?php
                                                                                                $date=date_create($rows->RECONFIRM_TIME);
                                                                                                ?>
                                                                                                <h4 style="color: #212121;font-size: 15px;">ORDER Date: <span style="color:#374957; font-weight: 100;">{{ $date->format('d F, Y') }}</span></h4>
                                                                                                <h4 style="text-align: center; padding-top: 50px;">Your order has been returned, if you need further information please contact us.</h4>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top"
                                                                                                ...
                                                                                                <p style="margin-top:0;margin-bottom:20px;margin:10px 0;padding:0;color:#869fb2;font-family:Helvetica;font-size:13px;line-height:150%;text-align:center">© 2021 easybazar, All rights reserved.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
