...
<head>
    ...
    <title>Your Order Has been Arrived in Warehouse</title>
</head>
<body>
    <!DOCTYPE html>
    <html lang="en">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" style="padding-top:0;padding-right:30px;padding-bottom:30px;padding-left:30px;word-break:break-word;color:#5f7d95;font-family:Helvetica;font-size:16px;text-align:left">
                                                                                                <p style="font-size:26px;color:#374957;margin:0;font-weight:600;padding:0;font-family:Helvetica,Arial;line-height:150%;text-align:left">GOOD NEWS!!!</p>
                                                                                                ...
                                                                                                <?php
                                                                                                $date=date_create($rows->CONFIRM_TIME);
                                                                                                ?>
                                                                                                <h4 style="color: #212121;font-size: 15px;">ORDER Date: <span style="color:#374957; font-weight: 100;">{{ $date->format('d F, Y') }}</span></h4>
                                                                                                <h4 style="text-align: center; padding-top: 50px;">Your order has arrived at our warehouse and it’s ready to ship.</h4>
                                                                                                <p style="text-align: center;padding-top: 20px;">Could you please settle your balance if you have with us, within agreed time?</p>
                                                                                                <h4 style="text-align: center;">Please ignore if you have settled your balance.</h4>

                                                                                                <p style="font-size: 15px;color: #374957;margin: 0;font-weight: 600;padding-top: 30px;font-family: Helvetica,Arial;line-height: 150%;text-align: left;">Yours<br>AZURAMART TEAM</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td valign="top" style="padding-top: 30px;padding-right: 30px;padding-bottom: 30px;padding-left: 30px;word-break: break-word;color: #5f7d95;font-family: Helvetica;font-size: 13px;line-height: 150%;text-align: left;font-weight: 600;">
                                                                                                ...
                                                                                                <a style="color: #374957; font-weight: 700;" href="#">Our Terms & Condition</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top"
                                                                                                ...
                                                                                                <p style="margin-top:0;margin-bottom:20px;margin:10px 0;padding:0;color:#869fb2;font-family:Helvetica;font-size:13px;line-height:150%;text-align:center">© 2021 AzuraMart, All rights reserved.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
