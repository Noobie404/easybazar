                            ...
                            <td align="center" valign="top" style="height:100%;margin:0;padding:0;width:100%">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                                    <tbody>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" style="padding-top:0;padding-right:30px;padding-bottom:30px;padding-left:30px;word-break:break-word;color:#5f7d95;font-family:Helvetica;font-size:16px;text-align:left">
                                                                                                <p style="font-size:26px;color:#374957;margin:0;font-weight:600;padding:0;font-family:Helvetica,Arial;line-height:150%;text-align:left">Cancellation Notice!!!</p>
                                                                                                ...
                                                                                                <?php
                                                                                                $date=date_create($rows->BOOKING_TIME);
                                                                                                ?>
                                                                                                <h4 style="color: #212121;font-size: 15px;">ORDER Date: <span style="color:#374957; font-weight: 100;">{{ $date->format('d F, Y') }}</span></h4>
                                                                                                <h4 style="text-align: center; padding-top: 50px;">We are sorry but we have cancelled your order, if you need further information please contact us.</h4>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" id="" style="background-color:#f8fafb;background-image:none;background-repeat:no-repeat;background-position:center;background-size:cover;border-top:0;border-bottom:0;padding-top:0px;padding-bottom:40px">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;max-width:600px">
                                                    <tbody>
                                                        <tr>
