                ...
                <div class="form-body">
                    <div class="col-md-6 offset-3">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                {!! Form::text('type', $data->TYPE ?? null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => __('form.field_required'), 'placeholder' => 'Enter Type', 'tabindex' => $tab_index++ ]) !!}
                            </div>
                            @if ($errors->has('type'))
                    ...
                    <div class="col-md-6 offset-3">
                        <div class="form-group">
                            <label>Width</label>
                            <div class="controls">
                                {!! Form::number('width', $data->WIDTH_CM ??  null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => __('form.field_required'), 'placeholder' => 'Enter width (cm)', 'tabindex' => $tab_index++ ]) !!}
                            </div>
                            @if ($errors->has('width'))
                                <div class="alert alert-danger">
                    ...
                    <div class="col-md-6 offset-3">
                        <div class="form-group">
                            <label>Length</label>
                            <div class="controls">
                                {!! Form::number('length', $data->LENGTH_CM ??  null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => __('form.field_required'), 'placeholder' => 'Enter length (cm)', 'tabindex' => $tab_index++ ]) !!}
                            </div>
                    ...
                    <div class="col-md-6 offset-3">
                        <div class="form-group">
                            <label>Height</label>
                            <div class="controls">
                                {!! Form::number('height', $data->HEIGHT_CM ??  null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => __('form.field_required'), 'placeholder' => 'Enter height (cm)', 'tabindex' => $tab_index++ ]) !!}
                            </div>
