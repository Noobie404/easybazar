...
@section('title') Box Type @endsection
@section('page-name') Box Type @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Box Type</a></li>
                                    ...
                                    <table class="table table-striped table-bordered alt-pagination table-sm" id="process_data_table_">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->HEIGHT_CM }}</td>
                                                <td>
                                                    @if(hasAccessAbility('add_box_type', $roles))
                                                        <a class="text-white btn btn-xs btn-primary mr-1" title="Edit" href="{{ route('admin.box_type.add', [$row->PK_NO] ) }}"><i class="la la-edit"></i></a>
                                                    @endif
