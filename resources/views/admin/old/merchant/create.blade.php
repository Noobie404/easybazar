...
@section('title') New Merchant @endsection
@section('page-name') New Merchant @endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content border-tab-content">
                            <div role="tabpanel" class="tab-pane active" id="productBasic" aria-labelledby="productBasic-tab1" aria-expanded="true">
                                {!! Form::open([ 'route' => 'admin.merchant.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('customername') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('customername',  null, ['class'=>'form-control mb-1', 'id' => 'customername', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter name', 'tabindex' => $tab_index++,  ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group  {!! $errors->has('mobileno') ? 'error' : '' !!}">
                                            ...
                                            {!! Form::text('mobileno',null,[ 'class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter mobile No', 'tabindex' => $tab_index++]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('altno') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('altno',  null, ['class'=>'form-control mb-1', 'id' => 'altno',  'placeholder' => 'Enter Alternative mobile no', 'tabindex' => $tab_index++,  ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('fbid') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('fbid',  null, ['class'=>'form-control mb-1', 'id' => 'fbid',  'placeholder' => 'Enter facebook id', 'tabindex' => $tab_index++,  ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('insid') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('insid',  null, ['class'=>'form-control mb-1', 'id' => 'insid',  'placeholder' => 'Enter instagram id', 'tabindex' => $tab_index++,  ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('email') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::email('email',  null, ['class'=>'form-control mb-1', 'id' => 'email', 'placeholder' => 'Enter email', 'data-validation-required-message' => 'This field is required', 'tabindex' => $tab_index++,  ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('ukpass') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::password('ukpass', ['class'=>'form-control mb-1', 'id' => 'ukpass',  'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter azuramart pass', 'tabindex' => $tab_index++,  ]) !!}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {!! $errors->has('short_name') ? 'error' : '' !!}">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('short_name', null, ['class'=>'form-control mb-1', 'id' => 'short_name', 'placeholder' => 'Enter short name', 'data-validation-required-message' => 'This field is required', 'tabindex' => $tab_index++, 'minlength' => 3, 'maxlength' => 3, 'data-validation-maxlength-message' => 'This field is required',  ]) !!}
