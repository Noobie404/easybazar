...
@section('view_reseller_refund','active')

@section('title') Refund to Reseller @endsection
@section('page-name')Refund to Reseller @endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Refund to Reseller</li>
@endsection
...
<div class="card card-success min-height">
    <div class="card-header">
        <h4 class="card-title" id="basic-layout-colored-form-control" style="text-transform: capitalize;">Refund to Reseller</h4>
        @if($errors->any())
    ...
    <div class="card-content collapse show">
        <div class="card-body">
            {!! Form::open([ 'route' => 'admin.paymentrefund.store.reseller', 'method' => 'post', 'class' => 'form-horizontal paymentEntryFrm prev_duplicat_frm', 'files'
            => true , 'novalidate']) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group mb-0 {!! $errors->has('cust_bank_name1') ? 'error' : '' !!}">
                                                    <div class="controls">
                                                        {!! Form::select('cust_bank_name1', $data['mybank_list'] ?? [], $data['refund_request']->F_ACC_BANK_LIST_NO, [ 'class' => 'form-control','placeholder' => 'Bank name', 'tabindex' => 0 , 'disabled']) !!}
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group mb-0 {!! $errors->has('bank_no') ? 'error' : '' !!}">
                                                <div class="controls">
                                                    {!! Form::select('bank_no', $data['mybank_list'] ?? [], $data['refund_request']->F_ACC_BANK_LIST_NO ?? null, [ 'class' => 'form-control  select3', 'data-validation-required-message' => 'This field is required','placeholder' => 'Bank name', 'tabindex' => 1 , 'id' => 'bank_no']) !!}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="controls">
                                                {!! Form::text('paid_by', Auth::user()->NAME,[ 'class' => 'form-control ', 'placeholder' => 'Paid by', 'tabindex' => 10, 'id' => 'paid_by' ]) !!}
