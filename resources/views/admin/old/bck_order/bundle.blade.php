...
@if((request()->route()->getName() != 'admin.order.view'))
    ...
    <div class="card-header pb-0">
        ...
        <div class="heading-elements" style="z-index: 2;">
            <div style="display: inline-block" class="mr-1">
                ...
                <h4 style="display: inline-block;width: 125px;">ORDER DATE:</h4> <input type='text' style="display: inline-block;width: 200px;" class="form-control pickadate" placeholder="Order Date" value="{{isset($data->CONFIRM_TIME) ? date('d-m-Y',strtotime($data->CONFIRM_TIME)) : date('d-m-Y')}}" name="order_date_" id="order_date_"/>
            </div>
        </div>
    </div>
