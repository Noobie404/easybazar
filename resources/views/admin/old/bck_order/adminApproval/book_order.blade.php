...
<style>
    ...
    hr {margin-top: 1rem;margin-bottom: 1rem;border: 0;border-top: 1px solid #f2dade;}
...
@section('content')
{{-- @if ($agent == 0 || $agent == $data->F_SHOP_NO) --}}
    ...
    <div class="card-header pb-0">
        ...
        <div class="heading-elements" style="z-index: 2;">
            <div style="display: inline-block" class="mr-1">
                ...
                <h4 style="display: inline-block;width: 125px;">ORDER DATE:</h4> <input type='text' style="display: inline-block;width: 200px;" class="form-control pickadate" placeholder="Order Date" value="{{isset($data->CONFIRM_TIME) ? date('d-m-Y',strtotime($data->CONFIRM_TIME)) : date('d-m-Y')}}" name="order_date_" />
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="margin-top: -80px;width: 30%;z-index: 1;position: relative;">
                        ...
                        <h4 style="width: 120px;display: inline-block"><strong>Created By : </strong></h4><h5 style="display: inline-block"><a href="javascript:void(0)">{{ $data->bookingCreatedBy->NAME }}</h5></a>
                    </div>
                    <div style="">
                    </div>
                    <?php
...
<script type="text/javascript" src="{{ asset('assets/pages/order_booking.js?v=1.1')}}"></script>
...
@endif
@if (isset($order->innstallmentPayment))
<script>
