                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group {!! $errors->has('agent') ? 'error' : '' !!}">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    {!! Form::select('agent', $agent, $data->F_SHOP_NO ?? '', ['class'=>'form-control mb-1 select2', 'data-validation-required-message' => 'This field is required', 'id' => 'booking_under']) !!}
...
<script type="text/javascript" src="{{ asset('assets/pages/book.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/pages/book_order.js')}}"></script>
