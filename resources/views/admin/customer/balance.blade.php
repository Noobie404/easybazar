        ...
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-tabs nav-top-border no-hover-bg nav-justified">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('admin.customer.balance',['id' => $customer->PK_NO,'type'=>$type]) }}">Balance</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card" >
                <div class="card-header border-bottom">
                    <h1 class="card-title">My Balance <a class="tab-text small-text float-right text-black" href="#">Request For Credit Refund</a></h1>
                </div>
                <div class="card-body">
                    <div class="mb-md-2">
                        <span class="badge badge-success">CREDIT BALANCE - RM {{ number_format($customer->CUM_BALANCE,2) }}</span>
