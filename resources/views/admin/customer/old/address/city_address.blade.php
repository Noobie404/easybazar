                    ...
                    <div class="form-body">
                        <div class="col-md-6 offset-3">
                            <div class="form-group">
                                <label>Country</label>
                                <div class="controls">
                                    {!! Form::select('country', $data['countryCombo'], $data->PK_NO ?? null, [ 'class' => 'form-control mb-1 select2 ', 'id'=>'country','placeholder'=>'Select Country' ,'data-validation-required-message' => 'This Filed Is Required']) !!}
                                </div>
                        ...
                        <div class="form-actions text-center">
                            <a title="Cancel" href="{{ route('admin.address.city_list') }} " class="btn btn-warning mr-1"> <i class="ft-x"></i> @lang('form.btn_cancle')</a>
