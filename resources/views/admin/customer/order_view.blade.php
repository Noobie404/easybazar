            ...
            <div class="card card-sm card-success" >
                ...
                {!! Form::hidden('', $booking->PK_NO, ['id'=>'booking_no']) !!}
                    ...
                    <h4 class="card-title ">
                        ...
                        <a class="account-order-track-btn btn btn-default float-right"  href="#!" target="_blank">My Order Current Position</a>
                    </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <table class="table" id="order_view_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border-bottom: .1rem solid #ebebeb">
                                            ...
                                            <td class="text-right">
                                                BDT <span class="price"> {{ number_format($line_total,2) }}</span>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                        ...
                                        <tr style="border-bottom: .1rem solid #ebebeb">
                                            ...
                                            <td>
                                                <span class="price">BDT {{ number_format($unit_price,2) }}</span>
                                            </td>
                                            <td class="account-order-table-item-qty">
                                                @if ($child->delete_qty > 0)
                                                <p style="color:#212529;">Deleted: {{ $child->delete_qty }}</p>
