...
@section('title') Customer's Payment @endsection
            ...
            <div class="card card-sm card-success" >
                <div class="card-body">
                    <ul class="nav nav-tabs nav-top-border no-hover-bg nav-justified">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('admin.customer.payments',['id' => $customer->PK_NO,'type'=>$type]) }}">Payments</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <h1 class="card-title">My Paymnets</h1>
                                ...
                                <div class="card-body">
                                                            ...
                                                            <tr class="dashboard-orders-table-content">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if($row->IS_TRANSFERRED == 1 )
                                                                        ...
                                                                        <p><a href="{{ route('admin.customer.view',$txn_to->F_TO_CUSTOMER) }}"> Transfered To (CUST-{{ $txn_to->CUSTOMER_NO }})  </a> {{ number_format($txn_to->AMOUNT,2) }}</p>
                                                                        @endforeach
                                                                        @endif
                                                                    @endif
                                                ...
                                                @endif
                                                    ...
                                                    <form action="{{ route('admin.customer.payments', ['id' => $customer->PK_NO]) }}" method="method">
