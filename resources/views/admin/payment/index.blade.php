        ...
        <div class="card-body">
            <div class="row mb-2">
                <div class="col-md-12 text-center">
                    <form class="form-inline" action="{{ route('admin.payment.list') }}" style="position: relative;" method="get">
                        ...
                        <a href="{{ route('admin.payment.list') }}" class="btn btn-info btn-sm">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
