...
class NotifyApiController extends BaseController
{
    ...
    public function getSendAllEmail(Request $request)
    {
        $this->resp = $this->notifyInt->getSendAllEmail($request);
        return $this->resp->msg;
    }

    public function getBillplzNonpaidAssign(Request $request)
    {
        $this->resp = $this->notifyInt->getBillplzNonpaidAssign($request);
        return $this->resp->data;
    }

    public function getBillplzDeleteExpired(Request $request)
    {
        $this->resp = $this->notifyInt->getBillplzDeleteExpired($request);
        return $this->resp->data;
    }
