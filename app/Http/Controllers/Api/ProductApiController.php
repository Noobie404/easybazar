...
class ProductApiController extends Controller
{
    ...
    public function getAllStockSearchList(Request $request){

        $response = $this->product->getAllStockSearchList($request);
        return response()->json($response, $response->code);
    }
    ...
    public function getMerStockSearchList(Request $request){

        $response = $this->product->getMerStockSearchList($request);
        return response()->json($response, $response->code);
    }
    ...
    public function postMerchantProductSearchList(Request $request){

        $response = $this->product->postMerchantProductSearchList($request);
        return response()->json($response, $response->code);
    }
    ...
    public function postProductStockList(Request $request){

        $response = $this->product->postProductStockList($request);
        return response()->json($response, $response->code);
    }
}
