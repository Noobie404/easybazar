...
class ShipmentApiController extends Controller
{
    ...
    public function MerchantshipmentReceived(Request $request){

        $response = $this->shipment->MerchantshipmentReceived($request);
        return response()->json($response, $response->code);
    }

    public function MerchantShipmentPost(Request $request){

        $response = $this->shipment->MerchantShipmentPost($request);
        return response()->json($response, $response->code);
    }

    public function MerchantshipmentList(Request $request){

        $response = $this->shipment->MerchantshipmentList($request);
        return response()->json($response, $response->code);
    }
