...
class BankStateController extends BaseController
{
    ...
    public function getMatchingList(Request $request)
    {
        ...
        ->select('ACC_BANK_TXN.TXN_DATE','ACC_BANK_TXN.AMOUNT_ACTUAL','ACC_BANK_TXN.F_ACC_PAYMENT_BANK_NO','ACC_BANK_TXN.F_CUSTOMER_PAYMENT_NO','ACC_BANK_TXN.F_RESELLER_PAYMENT_NO','ACC_BANK_TXN.PAYMENT_TYPE','ACC_CUSTOMER_PAYMENTS.CUSTOMER_NAME','ACC_RESELLER_PAYMENTS.RESHOP_NAME','ACC_CUSTOMER_PAYMENTS.PAID_BY as CU_PAID_BY','ACC_RESELLER_PAYMENTS.PAID_BY as RE_PAID_BY')
        ...
        $cust_name      = $payment->CUSTOMER_NAME ?? $payment->RESHOP_NAME;
        $paid_by        = $payment->CU_PAID_BY ?? $payment->RE_PAID_BY;
        $pay_amount     = abs($payment->AMOUNT_ACTUAL);
