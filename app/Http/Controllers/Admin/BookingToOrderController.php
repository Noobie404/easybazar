...
class BookingToOrderController extends BaseController
{
    ...
    public function __construct(OrderInterface $orderInt, BookingInterface $bookingInt, Booking $booking_model, Customer $customer, ProductVariant $prd_variant, Agent $agent, Country $country)
    {
    ...
    {
        $this->resp = $this->orderInt->ajaxDelete($id,$type,$booking_no);
