...
BEGIN
  ...
  IF IN_TYPE = 'customer' THEN
    ...
    ELSEIF IN_TYPE = 'seller' THEN
            ...
            SELECT PK_NO, F_SELLER_NO,F_PAYMENT_ACC_NO,MR_AMOUNT,PAYMENT_DATE,F_SS_CREATED_BY,PAYMENT_TYPE,PAYMENT_REMAINING_MR INTO VAR_ACC_CUSTOMER_PAYMENTS_PK_NO, VAR_F_CUSTOMER_NO, VAR_F_PAYMENT_ACC_NO, VAR_MR_AMOUNT, VAR_PAYMENT_DATE,VAR_F_SS_CREATED_BY,VAR_PAYMENT_TYPE,VAR_PAYMENT_REMAINING_MR FROM ACC_SELLER_PAYMENTS WHERE PK_NO = IN_PK_NO;
...
if(!empty($coupon_discount)){
                $total_price = ($subtotal+$postage_cost)-($coupon_discount);
            }
            else{
                $total_price = ($subtotal+$postage_cost)-($flat_discount);
            }

// $booking = Booking::find($booking->PK_NO);
            // $booking->POSTAGE_COST    = $postage_cost;
            // $booking->SUB_TOTAL       = $subtotal;
            // $booking->TOTAL_ITEM_QTY  = $total_qty;
            // $booking->TOTAL_PRICE     = $total_price;
            // $booking->COUPON_DISCOUNT = $coupon_discount;
            // $booking->DISCOUNT        = $flat_discount;           
            // $booking->update();
