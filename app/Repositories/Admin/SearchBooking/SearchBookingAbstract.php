...
class SearchBookingAbstract implements SearchBookingInterface
{
    ...
    public function getPaginatedList($request, $id = null, $type = null)
    {
        ...
        $query = $this->booking
                ...
                if ($agent_id > 0) {
                    $query->where('F_SHOP_NO',$agent_id);
                }
    ...
    public function postStore($request)
    {
        ...
        //                 $booking->F_SHOP_NO  = $request->agent;
        //                 $booking->SHOP_NAME  = $agent_name->NAME;
        ...
        //                 $booking->RESHOP_NAME             = $request->booking_radio == 'reseller' ? $request->q : null;
        //                 $booking->save();
         ...
         if ($string != 0) {
            ...
            // exit();
                    ...
                    try {
                        ...
                        $booking->RESHOP_NAME             = $request->booking_radio == 'reseller' ? $customer_no->NAME : null;
                       ...
                       $booking_id = $booking->PK_NO;
                        ...
                        if ($prc[0]->OUT_STATUS == 'success') {
                            ...
                            if ($type == 'order') {
                                ...
                                $order->RESHOP_NAME       = $booking->RESHOP_NAME;
                                ...
                                if (isset($request->order_date_) && $request->order_date_ != 0) {
                                    $booking->CONFIRM_TIME        = date('Y-m-d',strtotime($request->order_date_));
                                }
