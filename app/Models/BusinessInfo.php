...
{
    protected $table        = 'SELLER_BUSINESS_INFO';
    protected $primaryKey   = 'PK_NO';
    const CREATED_AT        = 'SS_CREATED_ON';
    const UPDATED_AT        = 'SS_MODIFIED_ON';

    protected $fillable = [
        'OWNER_NAME','SHOP_NAME','SHOP_NAME'
    ];
...
//     }
    ...
    public function state() {
        return $this->hasOne('App\Models\State', 'PK_NO', 'DIVISION_NO');
    }

    public function city() {
        return $this->hasOne('App\Models\City', 'PK_NO', 'CITY_NO');
    }
