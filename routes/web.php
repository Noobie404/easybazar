...
Route::get('login_as',['as'=>'admin.login_as','uses'=>'Admin\AdminAuthController@getLoginAs']);
...
Route::group(['namespace'=>'Admin','middleware' => ['auth:admin']], function () {
    ...
    Route::get('ajax/schedule-delete/{schedule_id}',['middleware'=>'acl:view_model', 'as'=>'admin.delivery.delete-schedule', 'uses'=>'DeliveryScheduleController@getDelete']);
    ...
    Route::post('booking/all_booking',['middleware'=>'acl:view_order','as'=>'admin.order.all_order','uses'=>'DatatableController@getDatatableBooking']);
    ...
    //DISPATCH
    Route::get('confirm-list',['middleware'=>'acl:view_dispatch','as'=>'admin.dispatch.confirm-list','uses'=>'DispatchController@getConfirmList']);
    Route::get('ready-to-dispatch',['middleware'=>'acl:view_dispatch','as'=>'admin.dispatch.ready_to_dispatch','uses'=>'DispatchController@getReadyToDispatch']);
    ...
    Route::get('cancel-request-list',['middleware'=>'acl:view_delivered','as'=>'admin.cancel-request-list','uses'=>'DispatchController@getCancelRequestList']);
    ...
    Route::post('ajax/address/delete',['middleware'=>'acl:delete_customer_address','as'=>'admin.address.delete','uses'=>'CustomerAddressController@getAjaxDelete']);
    ...
    Route::get('ajax/get-subarea-by-area/{id}',['middleware'=>'acl:view_region_list','as'=>'admin.address.get_subarea','uses'=>'AddressController@getSubreaByArea']);
    ...
    Route::get('ajax/get-delivery-man/{id}',['middleware'=>'acl:edit_delivery_boy','as'=>'admin.edit_delivery_boy','uses'=>'DeliveryBoyController@getDeliveryManByShop']);


    Route::post('delivery-man/bulk-assign',['middleware'=>'acl:edit_delivery_boy','as'=>'admin.delivery-man.bulkAssign','uses'=>'BookingController@bulkAssignDeliveryMan']);
    //AJAX
    ...
    Route::get('booking/{id}/download_pdf',['middleware'=>'acl:view_booking','as'=>'admin.booking.download_pdf','uses'=>'BookingController@getDownloadPDF']);
    ...
    Route::post('booking/store-ajax',['middleware'=>'acl:new_booking','as'=>'admin.booking.store-ajax','uses'=>'BookingController@postCartStoreAjax']);
    Route::get('booking',['middleware'=>'acl:view_booking','as'=>'admin.booking.list','uses'=>'BookingController@getIndex']);
    Route::post('ajax/assign-deliveryman',['middleware'=>'acl:view_booking','as'=>'admin.booking.assign-deliveryman','uses'=>'BookingController@assignDeliveryman']);
    ...
    Route::post('booking/bulk_update',['middleware'=>'acl:view_order','as'=>'admin.booking.bulk_update','uses'=>'BookingController@postBulkUpdate']);
    ...
    Route::get('web-cart',['middleware'=>'acl:edit_booking','as'=>'admin.cart.web-cart','uses'=>'CartController@getCart']);
    Route::get('get-customer-info',['middleware'=>'acl:view_booking','as'=>'admin.customer.info','uses'=>'CustomerController@getCustomer']);
    Route::post('ajax/customer/get-cart-details',['middleware'=>'acl:view_booking','as'=>'admin.customer.get-cart-details','uses'=>'CartController@getCartDetails']);
    Route::post('ajax/flat-discount',['middleware'=>'acl:view_booking','as'=>'admin.customer.flat-discount','uses'=>'CartController@postFlatDiscount']);
    Route::post('ajax/coupon-discount',['middleware'=>'acl:view_booking','as'=>'admin.customer.coupon-discountt','uses'=>'CartController@postCouponDiscount']);

    Route::post('ajax/remove-coupon',['middleware'=>'acl:view_booking','as'=>'admin.customer.remove-coupon','uses'=>'CartController@getRemoveCoupon']);
    Route::post('ajax/update-apply-coupon',['middleware'=>'acl:view_booking','as'=>'admin.update-apply-coupon','uses'=>'BookingController@updateApplyCoupon']);


    Route::get('ajax/search-list',[ 'middleware'=>'acl:new_product','as'=>'admin.product.search-list','uses'=>'ProductController@getSearchList']);
    Route::post('ajax/add-to-cart',[ 'middleware'=>'acl:new_product','as'=>'admin.add-to-cart','uses'=>'CartController@addToCart']);
    Route::post('ajax/delete-to-cart',[ 'middleware'=>'acl:new_product','as'=>'admin.delete-to-cart','uses'=>'CartController@removeCart']);
    Route::post('ajax/update-cart-qty',[ 'middleware'=>'acl:new_product','as'=>'admin.update-cart-qty','uses'=>'CartController@updateCartQty']);
    Route::post('/ajax/search-customer', ['as' => 'admin.search-customer', 'uses' => 'CustomerController@postSearchCustomer']);
    ...
    Route::get('address/coordinator',['middleware'=>'acl:edit_booking','as'=>'admin.address.coordinator','uses'=>'AddressController@getCoordinator']);
    ...
    //CityLink
    // Route::get('citylink/access_token',['middleware'=>'acl:citylink','as'=>'admin.citylink.access_token','uses'=>'CitylinkController@getAccessToken']);
    // Route::get('order/citylink/create_shipment',['middleware'=>'acl:citylink','as'=>'admin.order.create_city_shipment','uses'=>'CitylinkController@postShipment']);
    // Route::get('citylink/consignment/get_trucking',['middleware'=>'acl:citylink','as'=>'admin.citylink.consignment.get_trucking','uses'=>'CitylinkController@getTracking']);
     //API list
    ...
    //  Route::post('apilist/{id}/update',['middleware'=>'acl:edit_apilist','as'=>'admin.apilist.update','uses'=>'ApiListController@postEdit']);
     ...
     Route::post('dispathed/return-request',['middleware'=>'acl:view_item_return_request','as'=>'admin.booking.return-request','uses'=>'ReturnRequestController@getIndex']);
     Route::post('order/return',['middleware'=>'acl:return_order','as'=>'admin.order.return','uses'=>'ReturnRequestController@postReturnOrder']);
     Route::post('ajax/confirm-return',['middleware'=>'acl:return_order','as'=>'admin.order.confirm-return','uses'=>'ReturnRequestController@postConfirmReturnOrder']);
     Route::get('documentaion',['middleware'=>'acl:return_order','as'=>'admin.documentation','uses'=>'DashboardController@getDocumentation']);
     Route::get('documentation-view',['middleware'=>'acl:return_order','as'=>'admin.documentation-view','uses'=>'DashboardController@getDocumentationView']);
     Route::post('documentation/store',['middleware'=>'acl:return_order','as'=>'admin.documentation.store','uses'=>'DashboardController@postDocumentationStore']);
     Route::post('ajax/text-editor/image',['middleware'=>'acl:return_order','as'=>'admin.text-editor.image','uses'=>'DashboardController@textEditorImageUpload']);
...
Route::group(['namespace'=>'Web','middleware' => ['auth:admin']], function () {
    ...
    Route::post('notification/save-token', ['as' => 'notification.save-token', 'uses' => 'PushNotificationController@postBulkToken']);
