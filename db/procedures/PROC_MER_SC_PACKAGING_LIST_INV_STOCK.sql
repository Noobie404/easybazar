...
DROP PROCEDURE IF EXISTS `PROC_MER_SC_PACKAGING_LIST_INV_STOCK`$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PROC_MER_SC_PACKAGING_LIST_INV_STOCK`(SHIPMENT_NO Integer, IS_UPDATE Integer, OUT OUT_STATUS VarChar(20))
    NO SQL
Block1: BEGIN
